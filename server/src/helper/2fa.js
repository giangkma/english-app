 ...
 */
exports.generateUniqueSecret = () => {
  return authenticator.generateSecret();
};

/** Tạo mã OTP token */
exports.generateOTPToken = (username, serviceName, secret) => {
